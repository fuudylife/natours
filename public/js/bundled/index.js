...
if (userImgInputEl) userImgInputEl.addEventListener("change", handleDisplayUserPhoto);
...
},{"regenerator-runtime/runtime":"dXNgZ","./mapbox":"3zDlz","./login":"7yHem","./updateSettings":"l3cGY","./stripe":"10tSC"}],"dXNgZ":[function(require,module,exports) {
/**
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoiZnV1dWR5LWxpZmUiLCJhIjoiY2w0YXM5MGExMGZrNjNrcWd2OHN4MXJqcSJ9.Xuomspiw5LHGfov2tPODDw";
...
const bookTour = async (tourId)=>{
    const stripe = Stripe("pk_test_51LDn7ELkIuy4ljhbmhqosS2Zba6RGTKia0Mn6IwUcSAfbVitGJgHNzpTJvB9rvjcFeQw7OZfriokn7dVbdPv8QuQ00aeSSMvv7");
    try {
